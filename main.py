        ...
        if connection:
            try:
                ...
                if brief:
                    ...
                    print("Commands didnt work")
                print("DATA PARSED AND DISPLAYED")
            except:
                pass
        else:
...
if __name__ == '__main__':
    ...
    print("-------------")
    print(f"PROGRAM RUNNING IN http://{local_host}:{local_port}/")
    print("-------------")
